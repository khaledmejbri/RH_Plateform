...
class _DemandeAutorisationSortieCreateScreenState
  ...
  // Durée en minutes entre debut et fin (-1 si invalide)
  int _dureeMinutes() {
  ...
  Future<void> _submit() async {
    if (_dateJour == null) {
      _snack('Veuillez choisir la date');
      return;
    }
    if (_heureDebut == null || _heureFin == null) {
      _snack('Veuillez choisir les heures de début et de fin');
      return;
    }
    ...
    if (duree > 4 * 60) {
      _snack('La durée ne peut pas dépasser 4 heures (moitié de journée)');
      return;
    }
    if (_motifController.text.trim().isEmpty) {
      _snack('Veuillez indiquer un motif');
      return;
    }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Expanded(
                  child: Text(
                    "Autorisation de sortie courte (max 4h, moins de la moitié de la journée)",
          ...
          const _SectionLabel(text: "Date de sortie"),
          ...
          const SizedBox(height: 24),
          const _SectionLabel(text: "Horaires"),
          const SizedBox(height: 8),
          Row(
            children: [
              Expanded(
                child: _Tile(
                  ...
                  selected: _heureDebut != null,
                  onTap: () => _pickHeure(true),
                ),
              ),
              ...
              Expanded(
                child: _Tile(
                  ...
                  selected: _heureFin != null,
                  onTap: () => _pickHeure(false),
                ),
              ),
            ],
          ),
          ...
          const SizedBox(height: 24),
          const _SectionLabel(text: "Motif"),
          const SizedBox(height: 8),
          Container(
            decoration: BoxDecoration(
              color: Colors.white,
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Padding(
                  ...
                  child: Icon(Icons.notes_rounded, color: _teal),
                ),
